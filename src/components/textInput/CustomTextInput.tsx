...
export default function CustomTextInput({
  ...
  return (
    <View
      ...
      style={[styles.textInputContainer,onError&& styles.errorTextInput, isFocused && styles.focusedTextInput,{width: width,}, border && { borderColor:bc?colors.lightGray1:  '#E5E0E0', borderWidth:1 }, backgroundColor && { backgroundColor:bg?bg: colors.white}  ]}>
      ...
      editable={editable}
        style={[styles.textInput,onError&& styles.errorTextInput, isFocused && styles.focusedTextInput,{fontFamily:fontFamily&&fontFamily}]}
  ...
  placeholderTextColor={colors.inputPlaceholder}
      ...
      {/* {isSecure && (
        <TouchableOpacity onPress={toggleSecureEntry} style={styles.icon}>
          <FontAwesome5 name={secureTextEntry ? 'eye-slash' : 'eye'} color={colors.inputPlaceholder} />
        </TouchableOpacity>
      )} */}
      {suffixIcon && (
        <View style={{padding: 4}}>
